...
afsocket_dd_init(LogPipe *s)
{
  ...
  cfg_persist_names_add(cfg, persist_name, self->writer);
...
afsocket_dd_deinit(LogPipe *s)
{
  ...
  cfg_persist_names_remove(cfg, afsocket_dd_format_persist_name(self, TRUE));
